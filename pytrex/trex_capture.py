...
class TrexCapture(TrexObject):
    ...
    def stop_capture(self, limit: int = 1000, output: Optional[str] = None) -> List[dict]:
        """Stop capture.
    ...
    def fetch_capture_packets(self, pkt_count: int = 1000, output: Optional[str] = None) -> List[dict]:
